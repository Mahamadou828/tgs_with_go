...
func (c Core) Create(ctx context.Context, ni invoicingentity.NewInvoicingEntityDTO, now time.Time) (invoicingentity.InvoicingEntity, error) {
...
func (c Core) Update(ctx context.Context, id string, ni invoicingentity.UpdateInvoicingEntityDTO, now time.Time) (invoicingentity.InvoicingEntity, error) {
	i, err := c.invoicingStore.QueryByID(ctx, id)
	if err != nil {
		return invoicingentity.InvoicingEntity{}, err
	}
