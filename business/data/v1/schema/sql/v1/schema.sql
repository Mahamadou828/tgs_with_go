-- ************************* SqlDBM: PostgreSQL *************************
-- * Generated by SqlDBM: TGS_WITH_GO, v16 by formationsamake@gmail.com *
...
(
    ...
    price_incuding_taxes                decimal(10, 2) NOT NULL,
    price_excluding_taxes_in_eur        decimal(10, 2) NOT NULL,
    price_incuding_taxes_in_eur         decimal(10, 2) NOT NULL,
    ...
    servicefees_taxes                   decimal(10, 2) NOT NULL,
    servicefees_taxes_in_eur            decimal(10, 2) NOT NULL,
    created_at                          timestamp      NOT NULL,
    updated_at                          timestamp      NOT NULL,
    deleted_at                          timestamp      NULL,
...
(
    ...
    max_active_collaborator_per_month int          NOT NULL,
    created_at                        timestamp    NOT NULL,
    updated_at                        timestamp    NOT NULL,
    deleted_at                        timestamp    NULL,
...
(
    ...
    max_carbon_emission  int          NOT NULL,
...
CREATE TABLE "public".invoicing_entity
(
    "id"          uuid         NOT NULL,
...
CREATE INDEX FK_331 ON "public".invoicing_entity
    (
     enterprise_id
        );
...
-- ************************************** "public".enterprise_label

CREATE TABLE "public".enterprise_label
(
    "id"                  uuid         NOT NULL,
    enterprise_id         uuid         NOT NULL,
    name                  varchar(255) NOT NULL,
    ...
    deleted_at            timestamp    NULL,
    description           varchar(255) NOT NULL,
    allow_additional_info boolean      NOT NULL,
    CONSTRAINT PK_272 PRIMARY KEY ("id"),
    CONSTRAINT FK_276 FOREIGN KEY (enterprise_id) REFERENCES "public".enterprise ("id")
);

CREATE INDEX FK_278 ON "public".enterprise_label
    (
     enterprise_id
        );
...
(
    ...
    CONSTRAINT FK_335 FOREIGN KEY (invoicing_entity_id) REFERENCES "public".invoicing_entity ("id"),
    CONSTRAINT FK_366 FOREIGN KEY (policy_id) REFERENCES "public".enterprise_policy ("id")
);
...
CREATE INDEX FK_368 ON "public".enterprise_team
    (
     policy_id
        );
...
CREATE INDEX FK_303 ON "public"."user"
    (
     enterprise_team_id
        );
...
(
    ...
    stops_longitude    int          NOT NULL,
    stops_number       int          NOT NULL,
    stopsAddress       text         NOT NULL,
    additional_users   int          NOT NULL,
    distance           int          NOT NULL,
    nbr_of_passager    int          NOT NULL,
    flight_number      varchar(255) NOT NULL,
    train_number       varchar(255) NOT NULL,
    nbr_of_bagages     int          NOT NULL,
    ...
    CONSTRAINT FK_86 FOREIGN KEY (useri_id) REFERENCES "public"."user" ("id")
);
