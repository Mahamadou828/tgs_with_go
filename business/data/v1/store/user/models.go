...
type User struct {
	...
	AggregatorID    string      `db:"aggregatorId" json:"aggregatorId"`
	Active          bool        `db:"active" json:"active"`
	CognitoID       string      `db:"cognitoId" json:"cognitoId"`
	IsMonthlyActive bool        `db:"isMonthlyActive" json:"isMonthlyActive"`
